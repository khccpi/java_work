...
public class StrBuilderExample {
	...
	public static void main(String[] args) {
		...
		/*
		 # String 클래스의 단점
		 - String 클래스는 아주 많이 쓰이고 좋은 기능들을 많이 가지고 있지만 메모리를 과소비하는 단점이 있습니다.
		 - String 객체는 처음 초기화된 데이터에 변화를 주어야 하는 상황에서 기존 객체를 활용하지 않고 새로운 객체를 계속해서 생성합니다.
		 
		 # StringBuildeer, StringBuffer (자바 5버전부터 사용 가능)
		 - String 클래스 단점으로 인한 메모리 과부하 및 속도가 느려지는 현상을 개선하기 위해서 StringBuilder가 새롭게 추가되었습니다.
		 - StringBuilder는 기존 객체를 계속 재활용하면서 실제 객체 내부의 값을 변경하게 됩니다.
