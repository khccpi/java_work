...
public class WhileExample1 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 2. while문의 조건식을 검사해서 true면 반복문이 시작하고 false라면 반복문 종료.
		 3. while문 블록 내부가 한 번 진행되면(끝까지 내려가면) 다시 조건식을 검사하여 true라면 반복문 계속 진행하고 false라면 반복문 종료.
