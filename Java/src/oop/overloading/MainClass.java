...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("정사각형의 넓이 : " + cal.calcRectArea2(5));
		System.out.println("직사각형의 넓이 : " + cal.calcRectArea2(10,20));
		System.out.println("사다리꼴의 넓이 : " + cal.calcRectArea2(5,13,7));
	}
